Proceso Principal
	...
	preCargaAuto(auto);
	preCargaEmpleado(empleado);
	preCargaRepuestos(repuestos);
	preCargaPlanesDePago(planesDePago);
	preCargaVentas(venta);
	preCargaClientes(cliente);
...
subproceso preCargaEmpleado(empleado)
	definir i,j como entero;
	Para i <- 0 Hasta 99 Hacer
...
subproceso preCargaRepuestos(repuestos)
	definir i,j como entero;
	Para i<-0 Hasta 99 Hacer
		Para j<-0 Hasta 5 Hacer
			repuestos[i,j] <- '0';
...
FinSubProceso
subproceso preCargaVentas(venta)
	definir i,j como entero;
	Para i<-0 Hasta 99 Hacer
		Para j<-0 Hasta 5 Hacer
			venta[i,j] <- '0';
...
FinSubProceso
subproceso preCargaClientes(cliente)
	definir i,j como entero;
	Para i <- 0 Hasta 99 Hacer
		Para j <- 0 Hasta 1 Hacer
			cliente[i,j] <- '0';
...
subproceso preCargaplanesDePago(planesDePago)
	definir i,j como entero;
	Para i <- 0 Hasta 99 Hacer
		Para j <- 0 Hasta 2 Hacer
			planesDePago[i,j] <- '0';
